...
//        zooKeeper.create("/testwatcher",
//                "测试数据".getBytes(StandardCharsets.UTF_8),
//                ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);

//        String data = zw.readData("/testwatcher", true);
//        System.err.println(data);
//        zw.writerData("/testwatcher", "我草更新了吗");


        List<String> children = zw.getChildren("/01FASJFLAKSFNFJKLSAJ", true);
        children.forEach(System.err::println);

//        zw.createChildren("测试孩子数据", "/testwatcher/laoda");
//        zw.createPath("测试数据", "/01FASJFLAKSFNFJKLSAJ");
